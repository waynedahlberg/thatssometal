...
#import "../utils/noise/noise_header.metal"
#import "../utils/random/random_header.metal"


[[ stitchable ]] half4 noise(float2 position, half4 color, float2 size, float octaves, float2 offset, float zOffset, float scale, float isColored, float isRandom, float seed) {
